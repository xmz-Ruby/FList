...
export default defineUserConfig({
  ...
  theme: FileList([
    ...
    },
    {
      ...
      analysis: githubReleasesFilesAnalysis({ user: "rustdesk", repository: "rustdesk" }),
      // 下载代理配置,支持多个平台，参考:https://jjaw.cn/2024/8/3/flist-config-porxy/
      // 这个是为了解决github的国内下载慢的问题，和跨域问题，建议配置，不然pdf，txt，md等文件因为跨域无法预览
      // 如果你使用的不是 cloudflare Pages 部署需要删掉这一行，因为如果不是cloudflare Pages部署，这个代理是无法正常工作的
      downProxy: cloudflarePagesDownProxy(),
    ...
    },
    {
      ...
      analysis: fileUrlTreeAnalysis({
        ...
        "/OK影视-电视版-2.8.7.apk": "https://r2.mangzhexuexi.com/tvbox/OK%E5%BD%B1%E8%A7%86-%E7%94%B5%E8%A7%86%E7%89%88-2.8.7.apk",
        "/OK影视-手机版-2.8.7.apk": "https://r2.mangzhexuexi.com/tvbox/OK%E5%BD%B1%E8%A7%86-%E6%89%8B%E6%9C%BA%E7%89%88-2.8.7.apk",
        "/电视直播-油桃TV-20250306.apk": "https://r2.mangzhexuexi.com/tvbox/%E6%B2%B9%E6%A1%83TV-20250306.apk",
        "/电视直播-WebViewTV_1.10.7.apk": "https://r2.mangzhexuexi.com/tvbox/WebViewTV_1.10.7.apk"
      }),
    },
    {
      mountPath: "/常用工具",
